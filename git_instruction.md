...
Чтобы узнать о состоянии используйте

```
git status
```

Чтобы записать изменения необходимо добавить файл или файлы к следующему **коммиту** (сохранению) для этого введите команду
